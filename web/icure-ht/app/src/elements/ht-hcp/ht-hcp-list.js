    ...
    return html`
        <custom-style>
            <style is="custom-style">
                ...
                #newHcpDialog .buttons .modal-button--save {
                    background: var(--app-secondary-color);
                }
        ...
        <div class="container">
            <template is="dom-if" if="{{modeGrid}}">
                <div id="selectHcpOption">
                    ...
                    <div id="selectHcpOption_text">
                        [[nbHcpSelected]] [[localize('hc_par','Prestataire',language)]]
            ...
            <div class="btn-container export-btn-container nomobile">
                <template is="dom-if" if="{{!modeGrid}}">
                    <paper-button class="exportcsv-btn" on-tap="_exportListToCsv">[[localize('export_csv','Export to
                        CSV',language)]]
                    </paper-button>
                    <paper-button class="exportcsv-btn" on-tap="_openAddHcpDialog">[[localize('add_hcp','Add New
                        HCP',language)]]
                    </paper-button>
                    <paper-button class="exportcsv-btn" on-tap="_switchMode">[[localize('fusion_hcp','Fusionner
                        HCP',language)]]
                    </paper-button>
                </template>
                <template is="dom-if" if="{{modeGrid}}">
                    <paper-button on-tap="_switchMode">[[localize('can','Cancel',language)]]</paper-button>
                    <paper-button class="exportcsv-btn" on-tap="_openFusionDialog">[[localize('fusion_hcp','Fusionner
                        HCP',language)]]
                    </paper-button>
                </template>
            </div>
            ...
            <div class="add-btn-mobile">
                ...
                <div id="add-list-mobile" class\$="add-list-mobile [[isShown]]">
                    <template is="dom-if" if="[[!modeGrid]]">
                        <div class="add-elem-mobile" on-tap="_exportListToCsv">[[localize('export_csv','Export to
                            CSV',language)]]
                        </div>
                        <div class="add-elem-mobile" on-tap="_openAddHcpDialog">[[localize('add_hcp','Add New
                            HCP',language)]]
                        </div>
                        <div class="add-elem-mobile" on-tap="_switchMode">[[localize('fusion_hcp','Fusionner
                            HCP',language)]]
                        </div>
                    </template>
                    <template is="dom-if" if="[[modeGrid]]">
                        <div class="add-elem-mobile" on-tap="_switchMode">[[localize('can','Cancel',language)]]</div>
                        <div class="add-elem-mobile" on-tap="_openFusionDialog">[[localize('fusion_hcp','Fusionner
                            HCP',language)]]
                        </div>
                    </template>
                </div>
            ...
            <paper-dialog id="newHcpDialog">
                <h3>[[localize('add_hcp','Ajouter un prestataire',language)]]</h3>
                <div id="" class="formNewHcp">
                    <paper-input class="addHcpInput" label="[[localize('las_nam','Last name',language)]]" value="{{newHcp.lastName}}"></paper-input>
                    <paper-input class="addHcpInput" label="[[localize('fir_nam','First name',language)]]" value="{{newHcp.firstName}}"></paper-input>
                    <paper-input class="addHcpInput" label="[[localize('ema','Email',language)]]" value="{{newHcp.email}}"></paper-input>
                    <paper-input class="addHcpInput" label="[[localize('inami','NIHII',language)]]" value="{{newHcp.nihii}}"></paper-input>
                    <paper-input class="addHcpInput" label="[[localize('ssin','SSIN',language)]]" value="{{newHcp.ssin}}"></paper-input>
                </div>
                ...
                <div class="buttons">
                    ...
                    <paper-button dialog-confirm="" autofocus="" on-tap="confirmAddHcp" class="modal-button modal-button--save">[[localize('add','Add',language)]]
                    </paper-button>
                </div>
            </paper-dialog>
            ...
            <paper-dialog id="fusionDialog">
                ...
                <template is="dom-if" if="[[fusionSelected>=0]]">
                    ...
                    <label class="labelFusion">[[localize('name','Nom',language)]] :
                        [[_getNameHcp(idFusionHcp)]]</label>
                    <label class="labelFusion">[[localize('special','Spécialité',language)]] :
                        [[_getSpeciality(idFusionHcp)]]</label>
                    <label class="labelFusion">[[localize('email','E-mail',language)]] :
                        [[_getEmail(idFusionHcp)]]</label>
                </template>
                <div class="buttons">
                    <paper-button dialog-dismiss="" class="modal-button modal-button--cancel">
                        [[localize('can','Cancel',language)]]
                    </paper-button>
                    <paper-button dialog-confirm="" autofocus="" on-tap="confirmFusionHcp" class="modal-button modal-button--save">[[localize('fusion','Fusion',language)]]
                    </paper-button>
                </div>
            </paper-dialog>
        </div>
