        ...
        <paper-dialog id="formInformationDialog">
            <div class="form-panel">
                <paper-tabs selected="{{tabs}}">
                    <paper-tab id="tab-formInformation" class="form-tab">
                        <iron-icon icon="vaadin:form" class="marginRight10"></iron-icon>
                        <span class="nomobile">[[localize('form_info','Form informations',language)]]</span></paper-tab>
                    <paper-tab id="tab-jsonForm" class="form-tab">
                        <iron-icon icon="vaadin:code" class="marginRight10"></iron-icon>
                        <span class="nomobile">[[localize('form_code','Form code',language)]]</span></paper-tab>
                </paper-tabs>
                ...
                <div class="buttons">
                    <paper-button on-tap="_download">[[localize('download','Download',language)]]</paper-button>
                    <paper-button on-tap="_upload">[[localize('upload','Upload',language)]]</paper-button>
