        ...
        <paper-dialog id="userInformationDialog">
            <div class="user-panel">
                <paper-tabs selected="{{tabs}}">
                    <paper-tab id="tab-userInformation" class="adm-tab">
                        <iron-icon icon="vaadin:user" class="marginRight10"></iron-icon>
                        <span class="nomobile">[[localize('user_info','User informations',language)]]</span></paper-tab>
                    <paper-tab id="tab-delegations" class="adm-tab">
                        <iron-icon icon="vaadin:key" class="marginRight10"></iron-icon>
                        <span class="nomobile">[[localize('usr_deleg','User delegations',language)]]</span></paper-tab>
                </paper-tabs>
                ...
                <iron-pages selected="[[tabs]]" class="panel-content">
                    <page>
                        ...
                        <h4>Statut</h4>
                        <div class="line">
                            <vaadin-checkbox checked="{{isAdministrator}}" on-checked-changed="_administratorRoleChanged">
                                [[localize('adm','Administrator',language)]]
                            </vaadin-checkbox>
                            <vaadin-checkbox checked="{{agendaCreated}}" disabled="">[[localize('agd_crea','Agenda
                                created',language)]]
                            </vaadin-checkbox>
                        ...
                        <div class="line">
                            <paper-dropdown-menu class="input" label="[[localize('stat','Type',language)]]">
                                <paper-listbox slot="dropdown-content" selected="{{selectedUserHcp.type}}" attr-for-selected="id" selected-item="{{selectedHcpType}}" on-selected-changed="_selectedHcpStatusChanged">
                                    <paper-item id="persphysician">[[localize('prest','Prestataire',language)]]
                                    </paper-item>
                                    <paper-item id="medicalhouse">[[localize('medical_house','Medical
                                        house',language)]]
                                    </paper-item>
                                </paper-listbox>
                            </paper-dropdown-menu>
                ...
                <div class="buttons">
                    ...
                    <paper-button class="modal-button" on-tap="_saveUser">[[localize('save','Save',language)]]
                    </paper-button>
                </div>
            </div>
        </paper-dialog>
