...
class HtAdminAccountInformations extends TkLocalizerMixin(PolymerElement) {
  static get template() {
    return html`
        ...
        <div class="user-info-panel">
            <h4 class="section-title">[[localize('my_pro', 'My profil', language)]] - [[localize('acc_info',
                'Informations', language)]]</h4>
            ...
            <div class="tile">
                ...
                <div class="body">
                    ...
                    <template is="dom-if" if="[[_mismatch(userPassword,userConfirmation)]]">
                        <div class="error">[[localize('pass_nomatch','Passwords do not match',language)]]</div>
                    </template>
                    ...
                    <div id="printable">
                        <vaadin-checkbox colspan="2" checked="{{user.use2fa}}">[[localize('use_two_fac_aut','Use two
                            factors Authentication',language)]]
                        </vaadin-checkbox>
                    ...
                    <template is="dom-if" if="[[_isMedicalHouse(hcp.type)]]">
                        <div class="line" style="margin-top:10px">
                            <paper-radio-group selected="{{hcp.billingType}}">
                                ...
                                <paper-radio-button name="serviceFee">[[localize('serviceFee','A l\\'acte',language)]]
                                </paper-radio-button>
                                <paper-radio-button name="flatRate">[[localize('medicalHouse','Au forfait',language)]]
                                </paper-radio-button>
                            </paper-radio-group>
                        </div>
            ...
            <template is="dom-if" if="[[!_isMedicalHouse(hcp.type)]]">
                <div class="tile">
                    <h4 class="title">
                        ...
                        [[localize('info','Informations',language)]] [[localize('inv_prest','physician',language)]]
                    </h4>
                    <div class="body">
...
`;
  ...
  static get is() {
      return 'ht-admin-account-informations'
  }
...
customElements.define(HtAdminAccountInformations.is, HtAdminAccountInformations)
