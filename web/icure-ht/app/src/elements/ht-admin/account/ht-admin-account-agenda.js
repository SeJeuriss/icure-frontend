  ...
  static get template() {
    return html`
        ...
        <div class="agenda-panel">
            <h4>[[localize('my_pro', 'My profil', language)]] - [[localize('acc_agenda_info', 'agenda information',
                language)]]</h4>
            <div class="agendaContainer" id="agendaContainer">
                <h4>[[localize('list_of_vis_dia', 'List of visible diary in Mikrono', language)]]
                    <paper-icon-button class="add-btn" icon="icons:add-circle" on-tap="_addAgenda"></paper-icon-button>
                </h4>
                <div>
        ...
        <paper-dialog id="addDisplayedAgendaDialog">
            ...
            <div class="buttons">
                ...
                <paper-button class="modal-button modal-button--save" dialog-confirm="" autofocus="" on-tap="confirmSharingAgenda">[[localize('add','Add',language)]]
                </paper-button>
            </div>
        </paper-dialog>
`;
