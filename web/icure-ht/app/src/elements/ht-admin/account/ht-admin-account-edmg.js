  ...
  static get template() {
    return html`
        ...
        <div class="edmg-panel">
            <h4>[[localize('my_pro', 'My profil', language)]] - [[localize('acc_edmg_info', 'Edmg informations',
                language)]]</h4>
            ...
            <div class="horizontal">
                ...
                <template is="dom-if" if="[[!allEDmgregistered]]">
                    <paper-button disabled="[[!registerEnabled]]" on-tap="_registerToEDMG" class="modal-button modal-button--save">[[localize('reg_dmg','Register to
                        eDmg',language)]]
                    </paper-button>
                </template>
