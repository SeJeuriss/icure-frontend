        ...
        <div class="container">
            <div class\$="list-panel [[searchLoadContainerClass(searchLoadContainerCollapsed)]]">
                <div class="searchLoadContainer">
                    <div class\$="[[searchLoadContainerClass(searchLoadContainerCollapsed)]]">
                        <div class="chapter-text-row grey options-bar">
                            [[_formatDateShort(consultationStartDateAsString)]] -
                            [[_formatDateShort(consultationEndDateAsString)]] -
                            [[_formatParagraph(selectedLoadParagraph, language)]]
                            ...
                            <paper-item class="chapter-text">
                                <div class\$="chapter-text-row chapter-text-date [[_isInvalidClass(item)]] [[_willBeInvalidClass(item)]]">
                                    ...
                                    <div>
                                        ...
                                        &nbsp;
                                        <paper-tooltip for="from-[[item.decisionReference]][[item.ioRequestReference]]" position="left" animation-delay="0">Date de début de l'accord
                                        </paper-tooltip>
                                    ...
                                    <paper-tooltip for="to-[[item.decisionReference]][[item.ioRequestReference]]" position="left" animation-delay="0">Date de fin de l'accord
                                    </paper-tooltip>
                                ...
                                <div class="chapter-text-row grey">
                                    ...
                                    <div class="chapterDateInfo">
                                        ...
                                        <paper-tooltip for="ioref-[[item.decisionReference]][[item.ioRequestReference]]" position="left" animation-delay="0">[[item.decisionReference]]
                                            [[item.ioRequestReference]]
                                        </paper-tooltip>
                                    </div>
                                </div>
                            </paper-item>
                ...
                <div class="bottom-btn-container">
                    <paper-button disabled="[[_isLoadingChapter]]" class="bottom-btn" on-tap="_loadChapter4">
                        [[localize('load_agr','Load
                        agr.',language)]]
                    </paper-button>
                </div>
            </div>
                ...
                <div class="paragraph">
                    <template is="dom-if" if="[[displayedParagraph.paragraphInfo]]">
                        ...
                        <iron-pages selected="[[tabs]]" class="">
                            <page>
                                <div class="paragraph-content">
                                    <h2>[[localize('chapter','Chapter',language)]]
                                        [[displayedParagraph.paragraphInfo.chapterName]],
                                    ...
                                    <p>
                                        <template is="dom-if" if="[[_isFrench(language)]]">
                                            [[displayedParagraph.paragraphInfo.keyStringFr]]
                                        </template>
                                        <template is="dom-if" if="[[_isDutch(language)]]">
                                            [[displayedParagraph.paragraphInfo.keyStringNl]]
                                        </template>
                                    </p>
                                    <ul class="outer-ul">
                                    ...
                                    <template is="dom-if" if="[[agreementResponse]]">
                                        ...
                                        <template id="transactionRepeat" is="dom-repeat" items="[[agreementResponse.transactions]]" as="t">
                                            ...
                                            <div class="one-line">
                                                ...
                                                <template is="dom-if" if="[[t.inTreatment]]">
                                                    <div class="fleft third">
                                                        <p><b>[[localize('status','Status',language)]]:</b>
                                                            [[localize('req_in_tre','Request in treatment',language)]]
                                                        </p></div>
                                                </template>
                                                ...
                                                <div class="fleft third">
                                                    <p><b>[[localize('ref_io','Reference IO',language)]]:</b>
                                                        [[t.decisionReference]] [[t.ioRequestReference]]</p>
                                                </div>
                                                <template is="dom-if" if="[[t.start]]">
                                                    <div class="fleft third">
                                                        <p><b>[[localize('from','From',language)]]:</b>
                                                            [[_formatDate(t.start)]]</p></div>
                                                </template>
                                                <template is="dom-if" if="[[t.end]]">
                                                    <div class="fleft third">
                                                        <p><b>[[localize('to','to',language)]]:</b>
                                                            [[_formatDate(t.end)]]</p></div>
                                                </template>
                                            </div>
                                        ...
                                        <div class="one-line">
                                            <template is="dom-if" if="[[t.ioRequestReference]]">
                                                <div class="fleft third">
                                                    <p><b>[[localize('req_ref_io','Request Reference
                                                        IO',language)]]: </b>[[t.ioRequestReference]]</p>
                                                </div>
                                            </template>
                                            <template is="dom-if" if="[[t.responseType]]">
                                                <div class="fleft third">
                                                    <p><b>[[localize('raw_res','Raw response',language)]]:</b>
                                                        [[t.responseType]]</p>
                                                </div>
                                            </template>
                                            <template is="dom-if" if="[[agreementResponse.commonOutput.inputReference]]">
                                                <div class="fleft third">
                                                    <p><b>commonInput:</b>
                                                        [[agreementResponse.commonOutput.inputReference]]</p>
                                                </div>
                                            </template>
                                            <template is="dom-if" if="[[agreementResponse.commonOutput.nipReference]]">
                                                <div class="fleft third">
                                                    <p><b>nipReference:</b>
                                                        [[agreementResponse.commonOutput.nipReference]]</p>
                                                </div>
                                            </template>
                                            <template is="dom-if" if="[[agreementResponse.commonOutput.outputReference]]">
                                                <div class="fleft third">
                                                    <p><b>commonOutput:</b>
                                                        [[agreementResponse.commonOutput.outputReference]]</p>
                                                </div>
                                            </template>
                                        </div>
                        ...
                        <template is="dom-if" if="[[_missingAppendices(appendicesTokens.*, displayedParagraph.paragraphInfo, checkedVerses.*)]]">
                            <div class="warning">[[_missingAppendices(appendicesTokens.*, displayedParagraph)]]
                                [[localize('app_are_mis','appendices are missing', language)]]
                            </div>
                        </template>
                        <template is="dom-if" if="[[_unwantedAppendix(appendicesTokens.*, displayedParagraph.paragraphInfo, checkedVerses.*)]]">
                            <div class="error">[[localize('app_are_unw','No appendix is expected for this agreement
                                request. Adding one can delay the procedure.', language)]]
                            </div>
                        </template>

                        <div class="btns-container">
                            <template is="dom-if" if="[[_cancellation(isAgreementSelected, displayedParagraph)]]">
                                <paper-button class="bottom-btn" id="cancelChapter" on-tap="_cancelChapter" disabled="[[isClosingAgreement]]">[[localize('can_agr','Cancel
                                    agreement',language)]]
                                </paper-button>
                            ...
                            <template is="dom-if" if="[[_closure(isAgreementSelected, displayedParagraph)]]">
                                <paper-button class="bottom-btn" id="closeChapter" on-tap="_closeChapter" disabled="[[isClosingAgreement]]">[[localize('clos_agr','Close
                                    agreement',language)]]
                                </paper-button>
                                <ht-spinner class="asking" active="[[isClosingAgreement]]"></ht-spinner>
                            </template>
                            <template is="dom-if" if="[[_complimentaryAnnex(isAgreementSelected, displayedParagraph, appendicesTokens.*)]]">
                                <paper-button class="bottom-btn" id="complimentaryAnnex" on-tap="_requestChapter4" disabled="[[isAskingAgreement]]">
                            ...
                            <template is="dom-if" if="[[_extension(isAgreementSelected, displayedParagraph)]]">
                                <template is="dom-if" if="[[displayedParagraph.end]]">
                                    <paper-button class="bottom-btn" id="extendChapter" on-tap="_requestChapter4" disabled="[[isAskingAgreement]]">[[localize('ext_agr','Extend
                                        agreement',language)]]
                                    </paper-button>
                                    <ht-spinner class="asking" active="[[isAskingAgreement]]"></ht-spinner>
                                </template>
                            ...
                            <template is="dom-if" if="[[!isAgreementSelected]]">
                                <paper-button class="bottom-btn" id="requestChapter" on-tap="_requestChapter4" disabled="[[isAskingAgreement]]">
...
`;
  ...
  static get observers() {
      return ['_convertedMedications(medications.*)', '_appendicesChanged(appendices.*)', '_appendicesTokenChanged(appendicesToken.*)', '_selectAgreementInList(selectedAgreementIndex)', '_prepareIncomplete(appendicesTokens.*, displayedParagraph.paragraphInfo, checkedVerses.*)', '_medicationChanged(displayedParagraph.selectedMedication)']
  }
  ...
  _medicationChanged(mpp) {
      ...
      if (t && mpp) {
          if (t.service) {
              ...
              this.dispatchEvent(new CustomEvent('update-services', {
                  detail: {services: [t.service]},
                  bubbles: true,
                  composed: true
              }))
          }
  ...
  _convertedMedications() {
      return Promise.all((this.medications || []).filter(svc => Object.values(svc.content).some(c => !!c.medicationValue.paragraphAgreements && Object.keys(c.medicationValue.paragraphAgreements).length)).flatMap(svc => {
          ...
          return _.toPairs(agreements).map(([p, t]) => _.assign({}, t, {
              service: svc,
              paragraph: p,
              medications: [(content.medicationValue.medicinalProduct || {}).intendedname || (content.medicationValue.substanceProduct || {}).intendedname]
          }))
              ...
              .then(res => {
                  ...
                  return Promise.all(((res || {}) && res.transactions || []).map(t => {
                      ...
                      if (svc && t.accepted && t.decisionReference) {
                          ...
                          const paragraphAgreement = content.medicationValue.paragraphAgreements[this.displayedParagraph.paragraph]
                          if (paragraphAgreement) {
                              Object.assign(paragraphAgreement, {
                                  canceled: true,
