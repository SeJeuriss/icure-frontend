    ...
    return html`
        ...
        <collapse-button>
                    ...
                    <div class="btns">
                        <paper-menu-button>
                            ...
                            <paper-listbox slot="dropdown-content">
                                <paper-item id="he-edit-btn-edit_[[getHeId(he)]]" on-tap="_toggleEditHE">
                                    [[localize('edi','Edit',language)]]
                                </paper-item>
                                <template is="dom-if" if="[[isNotArchived(he)]]">
                                    <paper-item id="he-edit-btn-archive_[[getHeId(he)]]" on-tap="_archive">
                                        [[localize('arch','Archiver',language)]]
                                    </paper-item>
                                </template>
                                <template is="dom-if" if="[[isNotActive(he)]]">
                                    <paper-item id="he-edit-btn-active_[[getHeId(he)]]" on-tap="_activate">
                                        [[localize('mak_act','Make Active',language)]]
                                    </paper-item>
                                </template>
                                <template is="dom-if" if="[[isNotHistory(he)]]">
                                    <paper-item id="he-edit-btn-history_[[getHeId(he)]]" on-tap="_inactivate">
                                        [[localize('add_to_ant','Add to med history',language)]]
                                    </paper-item>
                                </template>
                                <paper-item id="he-edit-btn-evlink_[[getHeId(he)]]" on-tap="_linkToEvidenceLinker">
            ...
            <paper-listbox class="menu-content sublist sub-sublist" selected-items="{{he.selectedItems}}" multi="" toggle-shift="">
                <template is="dom-if" if="[[!he.plansOfAction.length]]">
                    <paper-item class="submenu-item list-info">
                        <div class="one-line-menu">[[localize('no_app','No approach',language)]]</div>
                        <paper-icon-button class="submenu-item-icon" icon="icons:add" on-tap="_addApproach"></paper-icon-button>
                    </paper-item>
                </template>
                ...
                <template is="dom-if" if="[[he.plansOfAction.length]]">
                    <paper-item class="submenu-item sublist-footer">
                        <div class="one-line-menu">[[localize('add_app','Add approach',language)]]</div>
                        <paper-icon-button class="submenu-item-icon" icon="icons:add" on-tap="_addApproach"></paper-icon-button>
                    </paper-item>
                </template>
            </paper-listbox>
  ...
  select(e) {
      ...
      if (navigator.platform.startsWith('Win') ? e.detail.sourceEvent.ctrlKey : e.detail.sourceEvent.metaKey) {
          this.dispatchEvent(new CustomEvent('selection-change', {
              detail: {
                  selections: [{
                      action: this.selected ? 'unselect' : 'select',
                      items: [this.getHeId(this.he)]
                  }]
              }
          }));
