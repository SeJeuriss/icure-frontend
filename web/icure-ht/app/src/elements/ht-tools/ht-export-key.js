  ...
  static get template() {
    return html`
        ...
        <paper-dialog id="dialog" opened="{{opened}}">
            <h2 class="modal-title">[[localize('sca_the_fol_cod_wit_you_tab','Scan the following code with your
                tablet',language)]]</h2>
            <div class="content">
                <div id="printable">
                    <qrcode-printer id="qrcode_printer" i18n="[[i18n]]" language="[[language]]" resources="[[resources]]" text="[[privateKeyPart]]" size="[[qrCodeWidth]]" ecl="H"></qrcode-printer>
                </div>
            </div>
            <div class="buttons">
                ...
                <paper-button class="modal-button modal-button--save" on-tap="_print">
                    [[localize('pri','Print',language)]]
                </paper-button>
                <paper-button dialog-confirm="" autofocus="" on-tap="confirm" class="modal-button modal-button--save">
