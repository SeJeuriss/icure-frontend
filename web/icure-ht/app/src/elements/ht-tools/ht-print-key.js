    ...
    return html`
        ...
        <paper-dialog id="dialog_printable" opened="{{opened}}">
            <div id="printable_image">
                <div id="printable_0">
                    <qrcode-printer i18n="[[i18n]]" language="[[language]]" resources="[[resources]]" id="qrcode_0" text="[[privateKeys.0]]" size="[[qrCodeWidth]]" ecl="H"></qrcode-printer>
                </div>
                <div id="printable_1">
                    <qrcode-printer i18n="[[i18n]]" language="[[language]]" resources="[[resources]]" id="qrcode_1" text="[[privateKeys.1]]" size="[[qrCodeWidth]]" ecl="H"></qrcode-printer>
                </div>
                <div id="printable_2">
                    <qrcode-printer i18n="[[i18n]]" language="[[language]]" resources="[[resources]]" id="qrcode_2" text="[[privateKeys.2]]" size="[[qrCodeWidth]]" ecl="H"></qrcode-printer>
                </div>
                <div id="printable_3">
                    <qrcode-printer i18n="[[i18n]]" language="[[language]]" resources="[[resources]]" id="qrcode_3" text="[[privateKeys.3]]" size="[[qrCodeWidth]]" ecl="H"></qrcode-printer>
                </div>
                <div id="printable_4">
                    <qrcode-printer i18n="[[i18n]]" language="[[language]]" resources="[[resources]]" id="qrcode_4" text="[[privateKeys.4]]" size="[[qrCodeWidth]]" ecl="H"></qrcode-printer>
                </div>
                <div id="printable_5">
                    <qrcode-printer i18n="[[i18n]]" language="[[language]]" resources="[[resources]]" id="qrcode_5" text="[[privateKeys.5]]" size="[[qrCodeWidth]]" ecl="H"></qrcode-printer>
                </div>
                <div id="printable_6">
                    <qrcode-printer i18n="[[i18n]]" language="[[language]]" resources="[[resources]]" id="qrcode_6" text="[[privateKeys.6]]" size="[[qrCodeWidth]]" ecl="H"></qrcode-printer>
                </div>
                <div id="printable_7">
                    <qrcode-printer i18n="[[i18n]]" language="[[language]]" resources="[[resources]]" id="qrcode_7" text="[[privateKeys.7]]" size="[[qrCodeWidth]]" ecl="H"></qrcode-printer>
                </div>
            </div>
        </paper-dialog>
`;
