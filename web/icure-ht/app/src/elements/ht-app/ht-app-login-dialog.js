  ...
  static get template() {
    return html`
        ...
        <paper-dialog id="loginDialog" opened="{{opened}}" modal="">
            ...
            <div style="text-align: center;"><!--img src="images/logo.png" style="width: 100px;" /--><h1>
                [[localize('ht','HT',language)]]</h1></div>
            ...
            <form is="form" id="login-form">
                <div class="layout vertical center flex">
                    ...
                    <template is="dom-if" if="[[!showMoreOption]]">
                        <paper-button class="toggleOptionsBtn" on-tap="_toggleMoreOption">
                            [[localize('more_login_options','More login options',language)]]
                            <iron-icon icon="expand-more"></iron-icon>
                        </paper-button>
                    </template>
                    <template is="dom-if" if="[[showMoreOption]]">
                        <paper-button class="toggleOptionsBtn" on-tap="_toggleMoreOption">
                            [[localize('less_login_options','Less login options',language)]]
                    ...
                    <template is="dom-if" if="[[!disabled]]">
                        <paper-button raised="true" id="submitButton" type="submit" on-click="login" autofocus="">
                            [[localize('log_in','Log in',language)]]
                        </paper-button>
                    </template>
                    <template is="dom-if" if="[[disabled]]">
                        <div class="in-place-of-btn">
                            <ht-spinner active="[[disabled]]"></ht-spinner>
                            [[localize('please_wait','Please wait ...',language)]]
                        </div>
                    </template>
                </div>
            </form>
  ...
  login() {
      ...
      this.dispatchEvent(new CustomEvent('login', {
          detail: {
              ...
              icureurl: currentIcureServerUrl,
              fhcurl: currentFhcServerUrl
