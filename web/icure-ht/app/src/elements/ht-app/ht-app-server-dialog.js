    ...
    return html`
        ...
        <paper-dialog id="add-server-dialog" opened="{{addServerOpened}}" horizontal-align="center" on-changed="_handleAddOpen">
            ...
            <form is="form" id="add-server-form">
                ...
                <paper-button dialog-dismiss="" elevation="0" animated="" aria-disabled="false" role="button" id="server-cancel" on-click="_handleCancel">[[localize('cancel','Cancel',language)]]
                </paper-button>
                <paper-button dialog-confirm="" raised="true" id="server-submit" type="submit" on-click="_handleServerAddition" autofocus="">[[localize('add','Add',language)]]
                </paper-button>
            </form>
        </paper-dialog>
`;
