...
class HtAppWelcome extends TkLocalizerMixin(PolymerElement) {
  static get template() {
    return html`
            ...
            <div class="container">
                <div class="left">
                    ...
                    <div>
                        ...
                        <p>If you already have a database in the cloud. You can copy your cloud key below and start
                            using iCure. </p>
                        ...
                        <paper-dropdown-menu label="Speciality" selected-item="{{specialityItem}}">
                            <paper-listbox slot="dropdown-content" class="dropdown-content">
                                <template is="dom-repeat" items="[[specialities]]" as="spec">
                                    <paper-item id="spec_[[spec.id]] ">[[localize(spec.descr, spec.descr, language)]]
                                    </paper-item>
                                </template>
                            </paper-listbox>
                        </paper-dropdown-menu>
...
`;
  ...
  static get properties() {
      return {
          ...
          specialities: {
              type: Array,
              value: [{id: '003', descr: 'general practitioner'}, {
                  id: '690',
                  descr: 'pediatrics'
              }, {id: '055', descr: 'dermatology'}, {id: '055', descr: 'gastroenterology'}, {
                  id: '340',
                  descr: 'gynecologyobstetrics'
              }]
          }
      };
  }
