  ...
  static get template() {
    return html`
        ...
        <div class="col-left">
            ...
            <paper-button id="new-msg-btn" class\$="new-msg-btn eh-[[ehealthSession]]" on-tap="_newMsg">
                [[localize('new_mes','New Message',language)]]
            </paper-button>
            <template is="dom-if" if="[[!ehealthSession]]">
                <paper-tooltip class="eh-disabled" for="new-msg-btn" position="bottom">
            ...
            <collapse-button id="inboxcollapse">
                <paper-item id="inbox" slot="sublist-collapse-item" class="menu-trigger menu-item" on-tap="_inbox" elevation="">
                    <div class="one-line-menu list-title inbox-line">
                        <div>
                            <iron-icon icon="icons:inbox" class="force-left"></iron-icon>
                            <span class="force-left force-ellipsis box-txt">[[localize('inb','Inbox',language)]]</span>
                        </div>
                        <template is="dom-if" if="[[unreadNumber]]"><span class="unreadNumber">[[unreadNumber]]</span>
                        </template>
                    </div>
                ...
                <paper-listbox id="inboxlist" class="menu-content sublist" selected="{{inboxSelectionIndex}}" selected-item="{{inboxSelectionItem}}" selectable="paper-item">
                    ...
                    <!--<paper-item class="one-line-menu menu-item" id="eheIn">[[localize('boxtitle.eheIn','eHealth inbox',language)]]</paper-item>-->
                    <paper-item class="one-line-menu menu-item flex-start" id="labResult">
                        <iron-icon icon="icons:assignment"></iron-icon>
                        [[localize('lab_res','Lab Results',language)]] / [[localize('rep','Report',language)]]
                    </paper-item>
                    <!--<paper-item class="one-line-menu menu-item" id="unsettedProtIn">[[localize('unassigned_labresults','unassigned lab results',language)]]</paper-item>-->
                    <!--<paper-item class="one-line-menu menu-item" id="protIn">[[localize('assigned_labresults','assigned lab results',language)]]</paper-item>-->
                    <!--<paper-item class="one-line-menu menu-item" id="reportIn">[[localize('rep','Report',language)]]</paper-item>-->
                    <paper-item class="one-line-menu menu-item flex-start" id="mycarenet">[[localize('mycarenet','My
                        Carenet',language)]]
                    </paper-item>
                </paper-listbox>
            </collapse-button>
            <collapse-button id="sentboxcollapse">
                <paper-item id="sentbox" slot="sublist-collapse-item" class="menu-trigger menu-item" on-tap="_sentbox" elevation="">
                    <div class="one-line-menu list-title">
                        <div>
                            ...
                            <span class="force-left force-ellipsis box-txt">[[localize('sen_mes','Send Messages',language)]]</span>
                        </div>
                        <template is="dom-if" if="[[sendNumber]]"><span class="unreadNumber force-ellipsis">[[sendNumber]]</span>
                        </template>
                    </div>
                    <!--<paper-icon-button class="menu-item-icon" icon="hardware:keyboard-arrow-down" hover="none" on-tap="toggleMenu"></paper-icon-button>-->
                </paper-item>
                ...
                <!--&lt;!&ndash;<paper-item class="one-line-menu menu-item" on-tap="_report">[[localize('rep','Report',language)]]</paper-item>&ndash;&gt;-->
                <!--&lt;!&ndash;<paper-item on-tap="_e_inv">[[localize('e_inv','E-Invoicing',language)]]</paper-item>&ndash;&gt;-->
                <!--</paper-listbox>-->
            </collapse-button>
            <collapse-button id="trashboxcollapse">
                <paper-item id="hidden" slot="sublist-collapse-item" class="menu-trigger menu-item" on-tap="_hidden" elevation="">
                    <div class="one-line-menu list-title">
                        <iron-icon icon="icons:visibility-off"></iron-icon>
                        <span class="force-left force-ellipsis box-txt">[[localize('hidden_msgs','Hidden messages',language)]]</span>
                    </div>
                    <paper-icon-button class="menu-item-icon" icon="hardware:keyboard-arrow-down" hover="none" on-tap="toggleMenu"></paper-icon-button>
                </paper-item>
                <paper-listbox id="trashboxlist" class="menu-content sublist" selected="{{trashSelectionIndex}}" selected-item="{{trashSelectionItem}}" selectable="paper-item">
                    <paper-item style="display:block;" class="one-line-menu menu-item flex-start" on-tap="_trash" id="trash" data-status="trash">
                        <iron-icon icon="icons:delete"></iron-icon>
                        [[localize('tra','Trash',language)]] eHealth
                    </paper-item>
                </paper-listbox>
            </collapse-button>
            <collapse-button id="invoiceboxcollapse">
                <paper-item id="invoicebox" slot="sublist-collapse-item" class="menu-trigger menu-item" on-tap="_invoicebox" elevation="">
                    <div class="one-line-menu list-title">
                        ...
                        <span class="force-left force-ellipsis box-txt">[[localize('serviceFeeInvoicing','Service fee invoicing',language)]]</span>
                        <template is="dom-if" if="[[sendNumber]]"><span class="unreadNumber">[[sendNumber]]</span>
                        </template>
                    </div>
                    <paper-icon-button class="menu-item-icon" icon="hardware:keyboard-arrow-down" hover="none" on-tap="toggleMenu"></paper-icon-button>
                </paper-item>
                <paper-listbox id="invoiceboxlist" class="menu-content sublist" selected="{{invoiceSelectionIndex}}" selected-item="{{invoiceSelectionItem}}" selectable="paper-item">
                    <paper-item class="one-line-menu menu-item" id="e_invOut" data-status="toBeCorrected">
                        [[localize('_e_inv_toBeCorrected','To be corrected',language)]] <span class="batchNumber batchToBeCorrected">[[batchCounter.toBeCorrected]]</span></paper-item>
                    <paper-item class="one-line-menu menu-item" id="e_invOut" data-status="toBeSend">
                        [[localize('_e_inv_toBeSend','To be send',language)]] <span class="batchNumber batchToBeSend">[[batchCounter.toBeSend]]</span>
                    </paper-item>
                    <paper-item class="one-line-menu menu-item" id="e_invOut" data-status="process">
                        [[localize('_e_inv_pro','Processing',language)]] <span class="batchNumber batchProcessed">[[batchCounter.processing]]</span>
                    </paper-item>
                    <paper-item class="one-line-menu menu-item" id="e_invOut" data-status="reject">
                        [[localize('_e_inv_rej','Rejected',language)]] <span class="batchNumber batchRejected">[[batchCounter.rejected]]</span>
                    </paper-item>
                    <paper-item class="one-line-menu menu-item" id="e_invOut" data-status="accept">
                        [[localize('_e_inv_acc','Accepted',language)]] <span class="batchNumber batchAccepted">[[batchCounter.accepted]]</span>
                    </paper-item>
                    <paper-item class="one-line-menu menu-item" id="e_invOut" data-status="archive">
                        [[localize('_e_inv_arc','Archived',language)]] <span class="batchNumber batchArchived">[[batchCounter.archived]]</span>
                    </paper-item>
                </paper-listbox>
            </collapse-button>

            <collapse-button id="flatRateInvoicingListingBoxCollapse" class="doNotDisplay">
                <paper-item id="flatRateInvoicingListingBox" slot="sublist-collapse-item" class="menu-trigger menu-item" on-tap="_toggleFlatRateInvoivingListingBox" elevation="">
                    <div class="one-line-menu list-title">
                        <iron-icon icon="accessibility"></iron-icon>
                        <span class="force-left force-ellipsis box-txt">[[localize('flatrateInvoicing','Facturation au forfait',language)]]</span>
                    </div>
                    <paper-icon-button class="menu-item-icon" icon="hardware:keyboard-arrow-down" hover="none" on-tap="toggleMenu"></paper-icon-button>
                </paper-item>
                <paper-listbox id="flatRateInvoicingListingBoxList" class="menu-content sublist" selected="{{flatRateInvoicingSelectionIndex}}" selected-item="{{flatRateInvoicingSelectionItem}}" selectable="paper-item">
                    <paper-item class="one-line-menu menu-item" id="e_flatrateinvOut" data-status="j3">
                        <div class="one-line-menu list-title">
                            <iron-icon icon="view-headline"></iron-icon>
                            <span class="force-left force-ellipsis box-txt">[[localize('_e_flatrateinv_listing','Export listing',language)]]</span>
                        </div>
                    </paper-item>
                    <paper-item class="one-line-menu menu-item" id="e_flatrateinvOut" data-status="archivej3">
                        <div class="one-line-menu list-title">
                            <iron-icon icon="markunread-mailbox"></iron-icon>
                            <span class="force-left force-ellipsis box-txt">[[localize('_e_flatrateinv_archives_listing','Archives listing',language)]]</span>
                        </div>
                    </paper-item>
                    <hr class="menuHr">
                    <paper-item class="one-line-menu menu-item" id="e_flatrateinvOut" data-status="j20_toBeCorrected">
                        <div class="one-line-menu list-title">
                            <iron-icon icon="error"></iron-icon>
                            <span class="force-left force-ellipsis box-txt">[[localize('j20_toBeCorrected','To be corrected',language)]]</span>
                        </div>
                        <span class="batchNumber j20_batchNumber batchToBeCorrected">[[j20_batchCounter.error]]</span>
                    </paper-item>
                    <paper-item class="one-line-menu menu-item" id="e_flatrateinvOut" data-status="j20_toBeSend">
                        <div class="one-line-menu list-title">
                            <iron-icon icon="send"></iron-icon>
                            <span class="force-left force-ellipsis box-txt">[[localize('j20_toBeSend','To be send',language)]]</span>
                        </div>
                        <!--<span class="batchNumber j20_batchNumber batchToBeSend">[[j20_batchCounter.xxx]]</span>--><span class="batchNumber j20_batchNumber batchToBeSend">+</span></paper-item>
                    <paper-item class="one-line-menu menu-item" id="e_flatrateinvOut" data-status="j20_process">
                        <div class="one-line-menu list-title">
                            <iron-icon icon="cached"></iron-icon>
                            <span class="force-left force-ellipsis box-txt">[[localize('j20_process','Processing',language)]]</span>
                        </div>
                        <span class="batchNumber j20_batchNumber batchProcessed">[[j20_batchCounter.pending]]</span>
                    </paper-item>
                    <paper-item class="one-line-menu menu-item" id="e_flatrateinvOut" data-status="j20_reject">
                        <div class="one-line-menu list-title">
                            <iron-icon icon="cancel"></iron-icon>
                            <span class="force-left force-ellipsis box-txt">[[localize('j20_reject','Rejected',language)]]</span>
                        </div>
                        <span class="batchNumber j20_batchNumber batchRejected">[[j20_batchCounter.rejected]]</span>
                    </paper-item>
                    <paper-item class="one-line-menu menu-item" id="e_flatrateinvOut" data-status="j20_partiallyAccepted">
                        <div class="one-line-menu list-title">
                            ...
                            <span class="force-left force-ellipsis box-txt">[[localize('j20_partiallyAccepted','Partially accepted batches',language)]]</span>
                        </div>
                        <span class="batchNumber j20_batchNumber batchToBeSend">[[j20_batchCounter.partiallyAccepted]]</span>
                    </paper-item>
                    <paper-item class="one-line-menu menu-item" id="e_flatrateinvOut" data-status="j20_accept">
                        <div class="one-line-menu list-title">
                            <iron-icon icon="check-circle"></iron-icon>
                            <span class="force-left force-ellipsis box-txt">[[localize('j20_accept','Accepted',language)]]</span>
                        </div>
                        <span class="batchNumber j20_batchNumber batchAccepted">[[j20_batchCounter.fullyAccepted]]</span>
                    </paper-item>
                    <paper-item class="one-line-menu menu-item" id="e_flatrateinvOut" data-status="j20_archive">
                        <div class="one-line-menu list-title">
                            <iron-icon icon="markunread-mailbox"></iron-icon>
                            <span class="force-left force-ellipsis box-txt">[[localize('j20_archive','Archived',language)]]</span>
                        </div>
                        <span class="batchNumber j20_batchNumber batchArchived">[[j20_batchCounter.archived]]</span>
                    </paper-item>
...
`;
  ...
  static get observers() {
      return [
          ...
          '_sentboxSelectionIndexChanged(sentboxSelectionIndex)',
          ...
          '_checkForMedicalHouse(user)',
          '_trashSelectionIndexChanged(trashSelectionIndex)',
  ...
  _updateUnreadCount() {
      this.set('unreadNumber', 0)
      this.api.message().findMessagesByTransportGuid('INBOX:*', null, null, 1000).then(messages => {
          messages.rows.forEach(m => {
              if ((m.status & 1 << 1) !== 0) {
                  this.set('unreadNumber', this.unreadNumber + 1)
              }
          })
      })
  }
  ...
  _inbox(e) {
      ...
      this.$.flatRateInvoicingListingBox.classList.remove('iron-selected')
      this.$.trash.classList.remove('iron-selected')
      this.$.hidden.classList.remove('iron-selected')
  ...
  _toggleFlatRateInvoivingListingBox(e) {
      e.stopPropagation()
      e.preventDefault()
      ...
      this.$.sentbox.classList.remove('iron-selected')
      this.$.invoicebox.classList.remove('iron-selected')
      this.$.flatRateInvoicingListingBox.classList.add('iron-selected')
      this.$.trash.classList.remove('iron-selected')
      this.$.hidden.classList.remove('iron-selected')
  }
  ...
  _invoiceSelectionIndexChanged() {
      if (this.invoiceSelectionIndex !== null && this.invoiceSelectionIndex !== undefined) {
          this.dispatchEvent(new CustomEvent('selection-change', {
              detail: {
                  selection: {
                      item: this.invoiceSelectionItem.id,
                      status: this.invoiceSelectionItem.dataset.status
                  }
              }
          }));
  ...
  _trashSelectionIndexChanged() {
      console.log('trashSelectionChanged', this.trashSelectionIndex, this.trashSelectionItem)
      if (this.trashSelectionIndex !== null && this.trashSelectionIndex !== undefined) {
          this.dispatchEvent(new CustomEvent('selection-change', {
              detail: {
                  selection: {
                      item: this.trashSelectionItem.id,
                      status: this.trashSelectionItem.dataset.status
                  }
              }
          }));
          ...
          this.$.invoicebox.classList.remove('iron-selected')
          this.$.flatRateInvoicingListingBox.classList.remove('iron-selected')
          this.$.trash.classList.add('iron-selected')
          this.$.hidden.classList.remove('iron-selected')
      }
  }
  ...
  _flatRateInvoicingSelectionIndexChanged() {
      if (this.flatRateInvoicingSelectionIndex !== null && this.flatRateInvoicingSelectionIndex !== undefined) {
          this.dispatchEvent(new CustomEvent('selection-change', {
              detail: {
                  selection: {
                      item: this.flatRateInvoicingSelectionItem.id,
                      status: this.flatRateInvoicingSelectionItem.dataset.status
                  }
              }
          }));
  ...
  _hidden(e) {
      ...
      this.dispatchEvent(new CustomEvent('selection-change', {detail: {selection: {item: 'hidden'}}}));
      this.set('sentboxSelectionIndex', null)
      this.set('inboxSelectionIndex', null)
      this.set('invoiceSelectionIndex', null)
      this.set('flatRateInvoicingSelectionIndex', null)

      // this.set('hiddenSelected','selected')
      ...
      this.$.flatRateInvoicingListingBox.classList.remove('iron-selected')
      this.$.trash.classList.remove('iron-selected')
      this.$.hidden.classList.add('iron-selected')
  ...
  _checkForMedicalHouse() {
      this.shadowRoot.getElementById("flatRateInvoicingListingBoxCollapse").classList.add("doNotDisplay");
      if (this.user && this.user.healthcarePartyId) {
          this.api.hcparty().getHealthcareParty(this.user.healthcarePartyId).then(hcp => {
              if (_.trim(_.get(hcp, "type", "")).toLowerCase() === 'medicalhouse') {
                  this.shadowRoot.getElementById("flatRateInvoicingListingBoxCollapse").classList.remove("doNotDisplay")
              }
          })
      }
  }
