            ...
            <paper-card class="pat-details-card">
                <template is="dom-if" if="[[!_isEqual(document.documentLocation,'body')]]">
                    <template is="dom-if" if="[[!isPatDetail]]">
                        ...
                        <paper-tooltip for="assign-ico-attach" position="left">[[localize('assign_to_pat','Assign to a
                            patient',language)]]
                        </paper-tooltip>
                    </template>
                </template>
        ...
        <template is="dom-if" if="[[isLabOrProtocol]]">
            <paper-card class="pat-details-card">
                <template is="dom-if" if="[[!isPatDetail]]">
                    ...
                    <paper-tooltip for="assign-ico-lab" position="left">[[localize('assign_to_pat','Assign to a
                        patient',language)]]
                    </paper-tooltip>
                </template>
                <span class="title">[[_title(document.name, title)]]</span>
                ...
                <template is="dom-if" if="[[unassigned.length]]">
                    <paper-button id="patients-importBtn" class="assignToPat" on-tap="openSuggestions" document\$="[[item]]">
                        [[localize('set_attach','Set attachment',language)]]
                        <iron-icon id="patients-icon" icon="assignment-ind"></iron-icon>
                    </paper-button>
                </template>
                <div class="pointers-line">
                    <template is="dom-if" if="[[downloadable]]">
                ...
                <template is="dom-repeat" items="[[labOrProtocolContent]]" as="resInfo">
                    <div class="resInfos">
                        ...
                        <div class="line"><b class="label">[[localize('document','Document',language)]]</b><span>[[resInfo.protocol]] - [[resInfo.labo]]</span>
                        </div>
                        <div class="line"><b class="label">[[localize('date','Date',language)]]</b><span>[[_formatDate(resInfo.demandDate)]]</span>
                        </div>
                        <template is="dom-if" if="[[resInfo.complete]]">
                            <div class="indicator">
                                <iron-icon icon="check"></iron-icon>
                                [[localize('com_res','Complete result',language)]]
                            </div>
                        </template>
                        <template is="dom-if" if="[[!resInfo.complete]]">
                            <div class="indicator">
                                <iron-icon icon="info"></iron-icon>
                                [[localize('inc_res','Incomplete result',language)]]
                            </div>
                        </template>
                    </div>
...
`;
  ...
  openSuggestions() {
      this.dispatchEvent(new CustomEvent('open-suggestions', {
