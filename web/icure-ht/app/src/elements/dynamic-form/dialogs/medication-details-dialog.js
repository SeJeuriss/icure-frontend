  ...
  static get template() {
    return html`
        <style include="scrollbar-style dropdown-style dialog-style vaadin-icure-theme">
            ...
            .display-type-regimen .regimen-txt {
                flex: 1;
                text-align: right;
            }
        ...
        <paper-dialog id="medication-detail" always-on-top="true" no-cancel-on-outside-click="true">
            ...
            <div class="content">
                <template is="dom-if" if="[[medications.length]]">
                    <paper-tabs selected="{{selectedMedication}}">
                        <template is="dom-repeat" items="[[medications]]">
                            <paper-tab>
                                <iron-icon icon="vaadin:pill" class="marginRight10"></iron-icon>
                                <span>[[_medicationName(item.newMedication)]]</span>
                            </paper-tab>
                        </template>
                    </paper-tabs>
                </template>
                ...
                <div class="regimen-line display-type-regimen">
                    ...
                    <vaadin-checkbox checked="[[selectedMedicationContentWithId.medicationValue.substitutionAllowed]]" id="substitutionAllowed" on-checked-changed="_substitutionAllowedChanged">
                        [[localize('substitution', 'Substitution', language)]]
                    </vaadin-checkbox>

                    <vaadin-checkbox id="renewal" checked="[[selectedMedicationContentWithId.medicationValue.isRenewal]]" on-checked-changed="_renewalValueChanged">[[localize('renewal', 'Renewal',
                        language)]]
                    </vaadin-checkbox>
                ...
                <div id="main-table" class="regimen-lines">
                            ...
                            <template is="dom-if" if="[[openAddDropDown]]">
                                <template is="dom-if" if="[[!selectedTab]]">
                                    <div class="btn-dropdown-container">
                                        <paper-item id="weekly" on-tap="_pushRegimen" data-item="weekly">
                                            [[localize('wee','Weekly',language)]]
                                        </paper-item>
                                        <paper-item id="monthly" on-tap="_pushRegimen" data-item="monthly">
                                            [[localize('mon','Monthly',language)]]
                                        </paper-item>
                                    </div>
                                </template>
                            </template>
                    ...
                    <div class="add-col">
                        <paper-listbox id="dayListbox" class\$="btn-dropdown-container visible-[[openAddColDropDown]]" slot="dropdown-content" selected="[[tempColToAdd]]" on-selected-changed="_addCustomDayPeriod" attr-for-selected="id">
                            <paper-item class="timeOfDay" id="morning" on-tap="" data-item="daily">
                                [[localize('ms_morning','morning',language)]]
                            </paper-item>
                            <paper-item class="timeOfDay" id="evening" on-tap="" data-item="weekly">
                                [[localize('ms_evening','evening',language)]]
                            </paper-item>
                            <paper-item class="timeOfDay" id="night" on-tap="" data-item="monthly">
                                [[localize('ms_night','night',language)]]
                            </paper-item>
                        ...
                        <template is="dom-if" if="[[!_isEqual(rg.dayPeriod.code,'custom')]]">
                            <paper-dropdown-menu label="[[localize('tod','Time of day',language)]]" class="regimen--tod" id="{{rg.dayPeriod.code}}">
                                <paper-listbox id="daylyListbox" slot="dropdown-content" selected="{{rg.dayPeriod.code}}" attr-for-selected="id" on-selected-changed="_selectDayPeriod" value="[[rg.dayPeriod.code]]">
                                    <paper-item id="beforebreakfast">
                                        [[localize("beforebreakfast",'Beforebreakfast',language)]]
                                    </paper-item>
                                    <paper-item id="duringbreakfast">
                                        [[localize("duringbreakfast",'Duringbreakfast',language)]]
                                    </paper-item>
                                    <paper-item id="afterbreakfast">
                                        [[localize("afterbreakfast",'Afterbreakfast',language)]]
                                    </paper-item>
                                    <paper-item id="morning">[[localize("morning",'Morning',language)]]</paper-item>
                                    <paper-item id="beforelunch">[[localize("beforelunch",'Beforelunch',language)]]
                                    </paper-item>
                                    <paper-item id="afternoon">[[localize("afternoon",'Afternoon',language)]]
                                    </paper-item>
                                    <paper-item id="duringlunch">[[localize("duringlunch",'Duringlunch',language)]]
                                    </paper-item>
                                    <paper-item id="afterlunch">[[localize("afterlunch",'Afterlunch',language)]]
                                    </paper-item>
                                    <paper-item id="beforedinner">[[localize("beforedinner",'Beforedinner',language)]]
                                    </paper-item>
                                    <paper-item id="duringdinner">[[localize("duringdinner",'Duringdinner',language)]]
                                    </paper-item>
                                    <paper-item id="afterdinner">[[localize("afterdinner",'Afterdinner',language)]]
                                    </paper-item>
                                    ...
                                    <hr>
                                    <paper-item id="custom">[[localize('precise_hour','Precise hour',language)]]
                                    </paper-item>
                                </paper-listbox>
            ...
            <div class="buttons">
                <template is="dom-if" if="[[_all(selectedMedicationContentWithId ,selectedMedicationContentWithId.isPrescription)]]">
                    <paper-checkbox id="createMedication" on-checked-changed="_createMedication" checked="{{selectedMedicationContentWithId.medicationValue.createMedication}}">
                        [[localize('create_med','Create medication',language)]]
                    </paper-checkbox>
                    <!-- Create medication <vaadin-checkbox id="createMedication" on-checked-changed="_createMedication"></vaadin-checkbox> -->
                </template>
                <paper-button dialog-confirm="" autofocus="" on-tap="cancel" class="modal-button modal-button--cancel">
                    [[localize('can','Cancel',language)]]
                </paper-button>
                <template is="dom-if" if="[[!_all(selectedMedicationContentWithId ,selectedMedicationContentWithId.isPrescription)]]">
                    <paper-button dialog-confirm="" autofocus="" on-tap="endAndClose" class="modal-button modal-button--save">
                        [[localize('clo2','End',language)]]
                    </paper-button>
                    <paper-button dialog-confirm="" autofocus="" on-tap="EOLAndClose" class="modal-button modal-button--save">
                        [[localize('del','Delete',language)]]
                    </paper-button>
                </template>
                <paper-button dialog-confirm="" autofocus="" on-tap="saveAndClose" class="modal-button modal-button--save">
...
`;
  ...
  _selectedMedicationChanged(idx) {
      ...
      this.set('selectedMedicationContentWithId', Object.assign(this.extractContentWithIdFromMedicationService(this.medications[idx].newMedication, true, this.medications[idx].options.isPrescription), {
          beginMomentAsString: this.api.moment((this.selectedMedicationContentWithId && this.selectedMedicationContentWithId.medicationValue && this.selectedMedicationContentWithId.medicationValue.beginMoment) || (medicationDetail.newMedication && medicationDetail.newMedication.valueDate) || (medicationDetail.newMedication && medicationDetail.newMedication.openingDate) || Date.now()).format('YYYY-MM-DD') || null,
          endMomentAsString: this.api.moment((this.selectedMedicationContentWithId && this.selectedMedicationContentWithId.medicationValue && this.selectedMedicationContentWithId.medicationValue.endMoment) || (medicationDetail.newMedication && medicationDetail.newMedication.closingDate)) ? this.api.moment(this.selectedMedicationContentWithId.medicationValue.endMoment || (medicationDetail.newMedication && medicationDetail.newMedication.closingDate)).format("YYYY-MM-DD") : null
      }))
      ...
      ;(!this.reimbursementCodeRecipe || this.reimbursementCodeRecipe.length === 0 || !this.timeUnit || this.timeUnit.length === 0 ? this.api.code().findPaginatedCodes('be', 'CD-REIMBURSEMENT-RECIPE', '')
          ...
          .finally(() => {
              if (medicationDetail) {
                  ...
                  this.set('selectedMedicationContentWithId', selectedMedicationContentWithId || Object.assign(this.extractContentWithIdFromMedicationService(medicationDetail, false), {
                      beginMomentAsString: this.api.moment((preferredContent && preferredContent.medicationValue.beginMoment) || (medicationDetail.newMedication && medicationDetail.newMedication.valueDate) || (medicationDetail.newMedication && medicationDetail.newMedication.openingDate) || Date.now()).format('YYYY-MM-DD') || null,
                      endMomentAsString: this.api.moment(preferredContent && preferredContent.medicationValue.endMoment || medicationDetail.newMedication && medicationDetail.newMedication.closingDate) ? this.api.moment(preferredContent && preferredContent.medicationValue.endMoment || medicationDetail.newMedication && medicationDetail.newMedication.closingDate).format("YYYY-MM-DD") : null
                  }))
                  this._initSelectedMedicationContentWithId()
  ...
  openList(list) {
      ...
      if (this.medications.length) {
          this.open(this.medications[0].newMedication, this.extractContentWithIdFromMedicationService(this.medications[0].newMedication, true, this.medications[0].options.isPrescription), this.medications[0].boxes)
  ...
  _addRegimen(e) {
      if (!this.selectedTab) {
          ...
          if (!this.selectedMedicationContentWithId.medicationValue.regimen) {
  ...
  _pushRegimen(e) {
      ...
      if (!this.selectedMedicationContentWithId.medicationValue) {
  ...
  _changeBeginMoment() {
      if (this.selectedMedicationContentWithId && this.selectedMedicationContentWithId.beginMomentAsString) {
  ...
  _changeEndMoment() {
      if (this.selectedMedicationContentWithId && this.selectedMedicationContentWithId.endMomentAsString) {
  ...
  _strContains(str, test) {
      return str ? test ? str.includes(test) : false : false
  }
  ...
  _formatFreq(freq) {
      return (freq == 'monthly') ? 2 : (freq == 'weekly') ? 1 : 0
  }

  _selectTakeQuantity() {
      this.set('bufferNumberByFrequency', this.bufferNumberByFrequency <= 0 ? 1 : this.bufferNumberByFrequency)
  }
  ...
  _valueChanged() {
      ...
      this.dispatchEvent(new CustomEvent('value-changed', {
          detail: {
              medication: this.medicationDetail,
  ...
  _regimenTableDataProvider(frequency) {
      ...
      return (params, callback) => {
          if (!this.get('selectedMedicationContentWithId.medicationValue')) {
              callback([], 0);
              return
          }
          ...
          let tempRegimenTable = [
              {
                  moment: this.localize('beforemeal', 'before meal'),
                  regimens: beforeMeal,
                  morning: beforeMealRegimens.morning,
                  midday: beforeMealRegimens.midday,
                  evening: beforeMealRegimens.evening
              },
              {
                  moment: this.localize('duringmeal', 'during meal'),
                  regimens: duringMeal,
                  morning: duringMealRegimens.morning,
                  midday: duringMealRegimens.midday,
                  evening: duringMealRegimens.evening
              },
              {
                  moment: this.localize('aftermeal', 'after meal'),
                  regimens: afterMeal,
                  morning: afterMealRegimens.morning,
                  midday: afterMealRegimens.midday,
                  evening: afterMealRegimens.evening
              }
          ]
          ...
          ;[[0, scores.duringbreakfast, scores.duringbreakfast + 1, 105959], [110000, scores.duringlunch, scores.duringlunch + 1, 155959], [160000, scores.duringdinner, scores.duringdinner + 1, 240000]].forEach((quad, idx) => {
              ...
              if (extraBefore.length || extraAfter.length) {
                  ...
                  const createGridObject = (rg) => ({
                      moment: this.localize(rg.dayPeriod && rg.dayPeriod.code || null, rg.dayPeriod && rg.dayPeriod.code || this._formatTime(rg.timeOfDay)),
                      regimens: [rg],
                      morning: idx === 0 && rg || null,
                      midday: idx === 1 && rg || null,
                      evening: idx === 2 && rg || null
                  })
