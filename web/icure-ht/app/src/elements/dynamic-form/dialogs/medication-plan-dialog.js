        ...
        <paper-dialog id="medication-plan" always-on-top="true" no-cancel-on-outside-click="true">
            ...
            <h2 class="modal-title">[[_getModalTitle(selectedTab)]]
                <paper-tabs selected="{{selectedTab}}">
                    ...
                    <!--<paper-tab>[[localize('tab_hist','History',language)]]</paper-tab>-->
                                ...
                                <template is="dom-repeat" items="[[medicationsWithPosology.meds]]" as="m">
                                    <div class\$="tr [[_medicationClass(m.medication)]]">
                                        <div class="td reimbursed">
                                            ...
                                            <paper-tooltip for="reimbursedStatus">[[_chap4Status(m.medication)]]
                                            </paper-tooltip>
                                        </div>
                                        ...
                                        <div class="td" style="flex-grow: 2;">
                                            <span>[[_servicePosology(m.medication)]]</span></div>
                                        ...
                                        <div class="td td-input bf-bef">
                                            <iron-input allowed-pattern="[0-9]" bind-value="{{m.regimenTable.1.0.administratedQuantity.quantity}}">
                                                <input value="{{m.regimenTable.1.0.administratedQuantity.quantity::input}}">
                                            </iron-input>
                                        </div>
                                        <div class="td td-input bf-dur">
                                            <iron-input allowed-pattern="[0-9]" bind-value="{{m.regimenTable.2.0.administratedQuantity.quantity}}">
                                                <input value="{{m.regimenTable.2.0.administratedQuantity.quantity::input}}">
                                            </iron-input>
                                        </div>
                                        <div class="td td-input bf-aft">
                                            <iron-input allowed-pattern="[0-9]" bind-value="{{m.regimenTable.3.0.administratedQuantity.quantity}}">
                                                <input value="{{m.regimenTable.3.0.administratedQuantity.quantity::input}}">
                                            </iron-input>
                                        </div>
                                        ...
                                        <div class="td td-input lu-bef">
                                            <iron-input allowed-pattern="[0-9]" bind-value="{{m.regimenTable.5.0.administratedQuantity.quantity}}">
                                                <input value="{{m.regimenTable.5.0.administratedQuantity.quantity::input}}">
                                            </iron-input>
                                        </div>
                                        <div class="td td-input lu-dur">
                                            <iron-input allowed-pattern="[0-9]" bind-value="{{m.regimenTable.6.0.administratedQuantity.quantity}}">
                                                <input value="{{m.regimenTable.6.0.administratedQuantity.quantity::input}}">
                                            </iron-input>
                                        </div>
                                        <div class="td td-input lu-aft">
                                            <iron-input allowed-pattern="[0-9]" bind-value="{{m.regimenTable.7.0.administratedQuantity.quantity}}">
                                                <input value="{{m.regimenTable.7.0.administratedQuantity.quantity::input}}">
                                            </iron-input>
                                        </div>
                                        ...
                                        <div class="td td-input di-bef">
                                            <iron-input allowed-pattern="[0-9]" bind-value="{{m.regimenTable.9.0.administratedQuantity.quantity}}">
                                                <input value="{{m.regimenTable.9.0.administratedQuantity.quantity::input}}">
                                            </iron-input>
                                        </div>
                                        <div class="td td-input di-dur">
                                            <iron-input allowed-pattern="[0-9]" bind-value="{{m.regimenTable.10.0.administratedQuantity.quantity}}">
                                                <input value="{{m.regimenTable.10.0.administratedQuantity.quantity::input}}">
                                            </iron-input>
                                        </div>
                                        <div class="td td-input di-aft">
                                            <iron-input allowed-pattern="[0-9]" bind-value="{{m.regimenTable.11.0.administratedQuantity.quantity}}">
                                                <input value="{{m.regimenTable.11.0.administratedQuantity.quantity::input}}">
                                            </iron-input>
                                        </div>
                                        ...
                                        <div class="td" style="flex-grow: 2;"><span>[[_getMedicationClosingDate(m.medication)]]</span>
                                        </div>
                                        <div class="td td--comments" style="flex-grow: 4;"><span class="left">[[m.medication.instructionForPatient]]</span>
                                        </div>
                                    </div>
                                </template>
                            </template>
                                            ...
                                            <div class="line-container">
                                                <div class="line-total-width" style\$="width: [[totalWidth]]px;">
                                                    <div id="[[medication.id]]" class\$="line [[_medicationClass(medication)]] [[_isOver(medication.endDate)]]" style\$="[[_linePosition(medication.startDate, medication.endDate)]]">
                                                        <div class="name">[[medication.name]] -
                                                            [[medication.posology]]
                                                        </div>
                                                        <template is="dom-if" if="[[_endAfterCurrent(medication.endDate)]]">
                                                            <div class="until">until [[medication.endDate]]</div>
                                                        </template>
                                                    </div>
                                                    <paper-tooltip position="top" for="[[medication.id]]">
                                                    ...
                                                    <paper-tooltip position="top" for="[[medication.id]]reimbursedLine">
                                                        This medication is reimbursed until
                                                        [[medication.reimmbursementDateEnd]]
                                                    </paper-tooltip>
                                                </div>
                                            </div>
                    ...
                    <div class="patient">
                        <div class="general-infos">
                            <div class="infos-block">
                                ...
                                <div class="infos--address"><span>Address</span>[[_getHcpAdress]]</div>
                            </div>
                                ...
                                <div id="breakfast" class="table-container">
                                    ...
                                    <div class="table-body">
                                        <template is="dom-repeat" items="[[plan.meds]]" as="m">
                                            <div class="table-row">
                                                <div class="col col--med"><span class="med--name">[[_getTimeOfDay(m.during)]] [[_serviceDescription(m.medication)]]</span>
                                                </div>
                                                <div class="col col--photo">
                                                    <iron-icon class="medIcon" icon="medication-svg-icons:[[_getMedIcon(m)]]"></iron-icon>
                                                </div>
                                                <div class="col col--ed">[[_getMedicationClosingDate(m.medication)]]
                                                </div>
            ...
            <div class="buttons">
                <paper-button dialog-confirm="" autofocus="" on-tap="cancel" class="modal-button modal-button--cancel">
                    [[localize('close','Close',language)]]
                </paper-button>

                <!--<paper-button dialog-confirm autofocus on-tap="" class="modal-button modal-button--save">[[localize('add_medication','Add Medication',language)]]</paper-button>-->
...
`;
  ...
  static get observers() {
      return ['_medicationsChanged(medications.*)', '_patientPlanChanged(medications.*)']
  }
  ...
  _regimenTableDataProvider(frequency) {
      ...
      return (params, callback) => {
          ...
          this.regimenTable = [
              {
                  moment: this.localize('breakfast', 'breakfast'),
                  regimens: morningRegimens,
                  beforeMeal: getMeal(morningRegimens, 'beforebreakfast', frequency)
                  ,
                  duringMeal: getMeal(morningRegimens, 'duringbreakfast', frequency),
                  afterMeal: getMeal(morningRegimens, 'afterbreakfast', frequency)
              },
              {
                  moment: this.localize('lunch', 'lunch'),
                  regimens: middayRegimens,
                  beforeMeal: getMeal(middayRegimens, 'beforelunch', frequency)
                  ,
                  duringMeal: getMeal(middayRegimens, 'duringlunch', frequency),
                  afterMeal: getMeal(middayRegimens, 'afterlunch', frequency)
              },
              {
                  moment: this.localize('dinner', 'dinner'),
                  regimens: eveningRegimens,
                  beforeMeal: getMeal(eveningRegimens, 'beforedinner', frequency)
                  ,
                  duringMeal: getMeal(eveningRegimens, 'duringdinner', frequency),
                  afterMeal: getMeal(eveningRegimens, 'afterdinner', frequency)
              }
          ]
  ...
  _medicationsChanged() {
      ...
      this.medicationClassesWithPosology = _.sortBy(Object.values(this.medications.map(m => ({
          medication: m,
          regimenTable: this.extractRegimenSlices(((this.api.contact().preferredContent(m, this.language) || {}).medicationValue || {}).regimen, 'daily', [
  ...
  _getMedicationClosingDate(medication) {
      return medication && medication.closingDate ? this.api.moment(medication.closingDate).format("DD/MM/YYYY") : ""
  }

  _patientPlanChanged() {
      let medicationClass = this.medicationClassesWithPosology

      const medications = medicationClass.flatMap(classe => classe.meds)
      ...
      medications.map(m => {
          ...
          if ((regimens[0]).length > 0) {
              regimensTableByDayPeriod.beforeBreak.push({
                  ...
                  during: regimens[0],
                  after: [],
                  times: regimens[0].map(r => ({
                      tod: r.timeOfDay && r.timeOfDay !== "" ? r.timeOfDay : null,
                      pc: r.dayPeriod && r.dayPeriod.code && r.dayPeriod.code !== "" ? r.dayPeriod.code : null,
                      oth: (!r.timeOfDay && !r.dayPeriod) ? r.administratedQuantity : null
                  }))
              })
          }
          ...
          if (_(_.concat(regimens[1], regimens[2], regimens[3])).compact().uniq().value().length > 0) {
              regimensTableByDayPeriod.breakfast.push({
                  ...
                  during: regimens[2],
                  after: regimens[3],
                  times: _(_.concat(regimens[1], regimens[2], regimens[3])).compact().uniq().value().map(r => ({
                      tod: r.timeOfDay && r.timeOfDay !== "" ? r.timeOfDay : null,
                      pc: r.dayPeriod && r.dayPeriod.code && r.dayPeriod.code !== "" ? r.dayPeriod.code : null,
                      oth: (!r.timeOfDay && !r.dayPeriod) ? r.administratedQuantity : null
                  }))
          ...
          if (_(_.concat(regimens[5], regimens[6], regimens[7])).compact().uniq().value().length > 0) {
              regimensTableByDayPeriod.lunch.push({
                  ...
                  during: regimens[6],
                  after: regimens[7],
                  times: _(_.concat(regimens[5], regimens[6], regimens[7])).compact().uniq().value().map(r => ({
                      tod: r.timeOfDay && r.timeOfDay !== "" ? r.timeOfDay : null,
                      pc: r.dayPeriod && r.dayPeriod.code && r.dayPeriod.code !== "" ? r.dayPeriod.code : null,
                      oth: (!r.timeOfDay && !r.dayPeriod) ? r.administratedQuantity : null
                  }))
          ...
          if ((_(_.concat(regimens[9], regimens[10], regimens[11])).compact().uniq().value()).length > 0) {
              regimensTableByDayPeriod.dinner.push({
                  ...
                  during: regimens[10],
                  after: regimens[11],
                  times: _(_.concat(regimens[9], regimens[10], regimens[11])).compact().uniq().value().map(r => ({
                      tod: r.timeOfDay && r.timeOfDay !== "" ? r.timeOfDay : null,
                      pc: r.dayPeriod && r.dayPeriod.code && r.dayPeriod.code !== "" ? r.dayPeriod.code : null,
                      oth: (!r.timeOfDay && !r.dayPeriod) ? r.administratedQuantity : null
                  }))
