...
`;
  ...
  _delete(e) {
      ...
      this.dispatchEvent(new CustomEvent('delete-subform', {
          detail: {
              id: subContext.dataProvider.getId(),
              index
          }, composed: true
      }));
  }
