...
function getCellAttrs(dom: HTMLElement, extraAttrs: { [key: string]: any }) {
...
function setCellAttrs(node: any, extraAttrs: { [key: string]: any }) {
...
export function tableNodes(options: { [key: string]: any }) {
    let extraAttrs = options.cellAttributes || {}
    let cellAttrs: { [key: string]: any } = {
        colspan: {default: 1},
        rowspan: {default: 1},
    ...
    return {
        ...
        table_cell: {
            ...
            tableRole: "cell",
            isolating: true,
            parseDOM: [{tag: "td", getAttrs: (dom: HTMLElement) => getCellAttrs(dom, extraAttrs)}],
            toDOM(node: Node) {
        ...
        table_header: {
            ...
            isolating: true,
            parseDOM: [{tag: "th", getAttrs: (dom: HTMLElement) => getCellAttrs(dom, extraAttrs)}],
            toDOM(node: Node) {
...
export function tableNodeTypes(schema: any) {
